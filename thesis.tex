...
\frontmatter{}
% \begin{abstract}
%     We present a theoretical framework \blahblah
% \end{abstract}
...
% GR
\chapter{General Relativity}\label[chap]{chap:GR}
    {\import{chapters/2_General_Relativity/}{GR.tex}}



% DWs
\chapter{\tmptitle{Kinks in Cosmology}}\label[chap]{chap:cosmo}
...
\chapter{\tmptitle{Cosmic Phase Transition}}\label{chap:PT}
