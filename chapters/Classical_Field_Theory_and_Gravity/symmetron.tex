...
% -----------------------------------------------------
% labels: \label{[type]:CFTgrav:symmetron:[name]}
% -----------------------------------------------------


% The simplest modifications of gravity are constructed from the simplest of fields, namely scalar fields. A group of modified-gravity theories 



% Scalar-tensor gravity in four dimensions can be formulated in its most general terms



% \emph{Horndeski theory} formulates scalar--tensor gravity in four dimensions in its most general picture
...
% Now, the quintessence $\mathcal{L}_2$ gives a stress--energy tensor that is completely analogous to the 
...
% \paragraph{Scalar-tensor theories / Quintessence.} %
% \blahblah Horndeski theory $\mathcal{L}\ped{tot} = \mathcal{L}\ped{m} + M\nped{Pl}^2 \sum_{i=2}^{5} \mathcal{L}_i$, where $\mathcal{L}_i$ are \dots. General relativity is retrieved with $\mathcal{L}_4 = \mathcal{R}/2$ and $\mathcal{L}_{2,3,5}=0$. Adding $\mathcal{L}_2 = X(\phi)-V(\phi)$ gives quintessence.
