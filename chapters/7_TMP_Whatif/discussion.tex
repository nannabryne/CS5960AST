...
\subsection{Continued assessment}\label{sec:whatif:discussion:cont_verification}
    ...
    \Citet{vachaspatiKinksDomainWalls2006} gives a rough estimate of the force between a kink and an antikink. A possible way forward could involve such estimates for our setups, and see if this relates the distance $\abs{z\ped{w}(\tau,y) - \widebar{z}\ped{w}}$ to the resulting $\epsB[\epsilon]$ in any way. 
