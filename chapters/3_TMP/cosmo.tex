...
\phpar[about modified gravity etc.]
...
\phpar[reason for modification--auxiliary scalar fields and expansion]
...
% Quintessence
\section{\tmptitle{Topological defects}}\label{sec:cosmo:defects}
{\subimport{./}{defects.tex}}


% Quintessence
\section{\tmptitle{Quintessence}}\label{sec:cosmo:quintessence}
