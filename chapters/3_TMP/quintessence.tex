...
\subsection{General framework}\label{sec:cosmo:quintessence:framework}
    ...
    The dynamics of the bosonic field $\phi$ is described by the Einstein-frame action (see~\cref{sec:GR:diffgeo:conformal}) \comment{fix}
    ...
    \begin{figure}[h]
        ...
        \caption{The evolution of the (a)symmetron effective potential in (dashed red) solid blue. \figpanel{Panel I}~The potential before SSB, \figpanel{panel II}~at SSB, and \figpanel{panels III--VI} after SSB, with diluting density. \iftime{Add two balls.}
