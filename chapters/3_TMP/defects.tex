...
\subsection{Defect formation}\label{sec:cosmo:defects:formation}
    ...
    To study phase transitions it is helpful to use the \newconcept{effective potential} that takes into account the interaction between some field and a background. \rephrase{An effective potential can ensure that a scalar field does not really show itself until some critical temperature. % $T\ped{cr}$. 
