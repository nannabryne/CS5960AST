...
\section{Riemannian geometry}\label[sec]{sec:diffgeo:riemann}
    {\subimport{./}{riemann.tex}}


\section{Conformal geometry}\label[sec]{sec:diffgeo:conformal}
...
\section{Einstein's equation}\label[sec]{sec:diffgeo:einstein}
