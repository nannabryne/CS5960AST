% |||||||||||||||||||||||||||||||||||||||||||||||
% |||||| 7.3 Limitations and possibilities ||||||
% |||||||||||||||||||||||||||||||||||||||||||||||
...
% \rephrase{Now let us review the mathematical framework outside the context of verification.} 
% \section{Limits of the framework}
% We review the theory that builds this framework. \comment{Why?}%
...
should be uncomplicated. Considering $N$ spatial dimensions is straight-forward, at least if the topological defect is of codimension one (with $D=N-1$ spatial dimensions). %\comment{Comment about coordinates.}
...
% Similar lines-of-thought should be applicable to flat spacetimes where phase transition is triggered at a critical temperature instead of a critical density. \blahblah
%\blahblah