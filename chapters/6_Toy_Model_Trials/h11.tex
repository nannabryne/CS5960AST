...
\begin{itemize}
    ...
    % \item Stronger scalar-field fluctuations correspond to noisier gravitational-wave modes. \comment{COMMENT!}
...
\subsection{Gravitational radiation}\label{sec:results:h11:rho_gw}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=\linewidth]{Findings/avhijprimenorm.png}
...
\subsection{Comparison with analytical results}\label{sec:results:h11:comparison}
    ...
    \begin{figure}[hb!]
        ...
        \begin{subfigure}[b]{\linewidth}
            \centering
            \includegraphics[width=\linewidth]{Findings/hp_kspace_sim1.png}
        \caption{Simulation~\simnum{1} with $m_{\lcoord{j}}=2$ and $\epsast=0.08L_\#$. The upper-left panel in explanatory for all panels.}
        ...
        \begin{subfigure}[b]{\linewidth}
            \centering
            \includegraphics[width=\linewidth]{Findings/hp_kspace_sim3.png}
        ...
        \begin{subfigure}[b]{\linewidth}
            \centering
            \includegraphics[width=\linewidth]{Findings/hp_kspace_sim7.png}
    ...
    \begin{figure}[ht!]\ContinuedFloat
        \begin{subfigure}[b]{\linewidth}
            \includegraphics[width=\linewidth]{Findings/hp_kspace_sim2.png}
        ...
        \hfill
        \begin{subfigure}[b]{\linewidth}
            \includegraphics[width=\linewidth]{Findings/hp_kspace_sim5.png}
        \caption{Simulation~\simnum{5}: $m_{\lcoord{j}}=3$ and $\epsast=0.06L_\#$. The lower-right panel in explanatory for all panels.}
    ...
    % \speak{TO-DO: Make it clear that we normalise to unity.}
    ...
    %     \Diracdelta(k_x)\Diracdelta(k_y - \ell p)P_h(\tau , \vartheta; \ell) =  \Ft{h}\^{ij}(\tau, \vec{k}) \Ft{h}\_{ij}(\tau, \vec{k}).% \left\langle h\^{ij}(\tau, \vec{k}) h\_{ij}(\tau, \vec{k}) \right\rangle,
    ...
    % \end{equation}
    % \hl{Just realised, this is simply $2\hpAB^2$, not actually a power spectrum...}
    ...
    and directly from simulation, $\hpC$. %\footnote{Note that this is \emph{not} the power-spectrum output we get from~\gevolution, but $2\abs{\hpC(0,\lcoord{v},\lcoord{w})}^2$.}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{\linewidth}
            \centering
            \includegraphics[width=\linewidth]{Findings/hij_powerspec_sim3.png}
        ...
        \hfill
        \begin{subfigure}[b]{\linewidth}
            \includegraphics[width=\linewidth]{Findings/hij_powerspec_sim5.png}
        ...
        \end{subfigure}
        % %
        \caption{%The one-dimensional power spectrum as functions of angle $\vartheta$, normalised to unity; $P_h/\max{(P_h)}$.
...
\subsection{Review}
    ...
    \begin{itemize}
        ...
        % \iftime{Comment about Delta-functions?} 
