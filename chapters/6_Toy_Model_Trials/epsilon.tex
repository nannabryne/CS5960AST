...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{\figpanel{Left panel}~The scalar field value along $y$-coordinate \hl{XXX} at different redshifts. \figpanel{Right panel}~The wall coordinate as function of time. Note that the colour bar share the same axis as the \blahblah. \hl{Fix graph labels!}}
