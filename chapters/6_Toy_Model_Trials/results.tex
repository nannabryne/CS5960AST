...
We include in~\cref{sec:results:hindsight} some afterthoughts and comments about the simulations. %\comment{Not sure where it is best placed.}
% \speak{Consider writing \texttt{S2} instead of simulation~\simnum{2}.}
Simulation~\simnum{6} is considered unsuccessful as it blows up at around $a\approx 0.45$, see~\cref{app:misc:sim6}. Where this is considered in the analysis, the results are shown for only $a\in [a\ped{i}, 0.46]$.
%  We show in~\cref{app:misc:sim6}
