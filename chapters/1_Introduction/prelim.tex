...
\subsection{Cosmic scales}
    ...
    %  with Hubble constant $68\unit{km/s/Mpc}$
    ...
    % The scale factor and redshift are preferable to cosmic time, and we go roughly through their meaning in the following.

    % \speak{Somewhere write $H_0=(2997.9)^{-1} \unit{Mpc}^{-1}\mathrm{h}$.}
