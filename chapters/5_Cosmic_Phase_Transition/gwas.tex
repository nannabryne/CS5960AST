...
That said, we do not actually have these exact solutions in curved spacetime. %~\lcomment{Revise calculation, I forgot it\dots}. 
...
This~\lcnamecref{sec:PT:gwas} elaborates on the specific simulation configuration that is the toy model.
