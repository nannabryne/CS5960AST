...
\subsection{Linearised perturbations}\label{sec:pertwalls:eom_wall:linearised_pert}
    ...
    \end{equation}
    where the wall displacement variable $\epsilon$ is a linear perturbation, i.e.~$\epsilon^2 \simeq 0$, and $n\^\mu$ is the unit normal vector to the \emph{unperturbed} worldsheet. %
