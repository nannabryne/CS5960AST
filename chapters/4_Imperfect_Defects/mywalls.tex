...
\boxedeq{eq:pertwalls:mywalls:eom_final}{
    \varepsilon'' + \pclosed{\frac{3\alpha}{s}  + 2 d(s)} \varepsilon' + \omega^2\varepsilon = 0; \quad d(s)\triangleq \frac{9\alpha}{4 s \left( s^{3\alpha}-1 \right)}.%
    }
...
\subsection{Solution in matter-dominated universe}\label{sec:pertwalls:mywalls:sol_MD}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\linewidth]{Methodology/demo_analytical_epsilon.png}
        %%%%%%%%%%
