...
\notesImage[$\zeta$ and ``naive'' are same general solution with different initial conditions ][schematic solution]
...
% NOTES *******************************
\begin{notes}[1][GWs]
    \nnote{1}{(power through) Vary NG action $\to$ Analytical expression for SE tensor (with simple function)}
\end{notes}
% *************************************
\end{frame}
