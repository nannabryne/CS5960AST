...
We will in the following define the first and second kinds of the (regular) Bessel functions, spherical Bessel functions and Riccati--Bessel functions, collectively denoted $\Zv[]$, $\zn[]$ and $\Rn[]$, respectively. The second kinds are also called the Neumann, spherical Neumann and Riccati--Neumann functions. Conventions are shown in~\cref{tab:cylinder:Bessel_functions}, and we use $\nu\in\Complex$ and $n\in\Integer$ to denote the order.
